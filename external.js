...
// CHECK IF ALL SQUARES HAVE BEEN FILLED BY ADDING THE VALUES OF (T) UP -- THIS MEANS A DRAW
function drawCheck(){
  vari()
...
// IF IT'S COMPUTER'S TURN --> FINISHING MOVE FTW!
// IF THERE IS NO FINISHING MOVE -> Computer() to determine best option -> Check() for alert
...
function computer(){
  ...
  else if(sqr3 == " X " && sqr7 == " X " && sqr2T == 0 && turn == 1){
    document.tic.sqr2.value = " O "
    sqr2T = 1;
    turn = 0;
  }
...
// IF NO THREAT + NO WIN AVAILABLE -- AI to determine best option.
// Determined by valuing the squares in how valuable they are to winning combos. (ie: middle square has most winning combos --> highest priority)
...
// WIPE IT CLEAN FOR ANOTHER PWNAGE
